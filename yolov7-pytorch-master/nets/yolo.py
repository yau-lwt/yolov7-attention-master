...
class YoloBody(nn.Module):
    def __init__(self, anchors_mask, num_classes, phi, pretrained=False,phii = 2):
        ...
        if phii >= 1 and phii <= 3:
            ...
            self.P3_downsample_attention = attention_blocks[phii - 1](256)
            self.P4_downsample_attention = attention_blocks[phii - 1](512)
    def fuse(self):
        print('Fusing layers... ')
    ...
    def forward(self, x):
        ...
        if self.phii >= 1 and self.phii <= 3:
        ...
        if self.phii >= 1 and self.phii <= 3:
            P3_downsample = self.P3_downsample_attention(P3_downsample)
        # 40, 40, 256 cat 40, 40, 256 => 40, 40, 512
        ...
        if self.phii >= 1 and self.phii <= 3:
            P4_downsample = self.P4_downsample_attention(P4_downsample)
